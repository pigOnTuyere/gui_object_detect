...
train_configs = {'weights': 'yolo7.pt', 'cfg': '', 'data': 'data/coco.yaml',
       'hyp': 'data/hyp.scratch.p5.yaml', 'epochs': 300, 'batch_size': 16,
       'img_size': [640, 640], 'rect': False, 'resume': False, 'nosave': False,
       'notest': False, 'noautoanchor': False, 'evolve': False, 'bucket': '',
...
class YOLOTrain(QObject):
    yolo2main_train_msg = Signal(str)
    def __init__(self):
        super().__init__()
